...
class SyncBuildCommands:
    def build(self, *args: CommandArg) -> CommandDispatchResult:
        """Build a schematic
...
Source: `BuildCommand.java`"""
        return dispatch_sync(self, 'build', *args)

    def litematica(self, *args: CommandArg) -> CommandDispatchResult:
...
Source: `LitematicaCommand.java`"""
        return dispatch_sync(self, 'litematica', *args)

    def sel(self, *args: CommandArg) -> CommandDispatchResult:
...
Source: `SelCommand.java`"""
        return dispatch_sync(self, 'sel', *args)

    def s(self, *args: CommandArg) -> CommandDispatchResult:
        """Alias for `sel`."""
        return self.sel(*args)

    def selection(self, *args: CommandArg) -> CommandDispatchResult:
        """Alias for `sel`."""
        return self.sel(*args)
