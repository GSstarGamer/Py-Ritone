...
from ._core import dispatch_and_wait_sync, dispatch_sync
from ._types import CommandArg, CommandDispatchResult


class SyncNavigationCommands:
    def axis(self, *args: CommandArg) -> CommandDispatchResult:
...
Source: `AxisCommand.java`"""
        return dispatch_sync(self, 'axis', *args)

    def blacklist(self, *args: CommandArg) -> CommandDispatchResult:
...
Source: `BlacklistCommand.java`"""
        return dispatch_sync(self, 'blacklist', *args)

    def come(self, *args: CommandArg) -> CommandDispatchResult:
...
Source: `ComeCommand.java`"""
        return dispatch_sync(self, 'come', *args)

    def elytra(self, *args: CommandArg) -> CommandDispatchResult:
        """elytra time
...
Source: `ElytraCommand.java`"""
        return dispatch_sync(self, 'elytra', *args)

    def explore(self, *args: CommandArg) -> CommandDispatchResult:
        """Explore things
...
Source: `ExploreCommand.java`"""
        return dispatch_sync(self, 'explore', *args)

    def explorefilter(self, *args: CommandArg) -> CommandDispatchResult:
...
Source: `ExploreFilterCommand.java`"""
        return dispatch_sync(self, 'explorefilter', *args)

    def goal(self, *args: CommandArg) -> CommandDispatchResult:
...
Source: `GoalCommand.java`"""
        return dispatch_sync(self, 'goal', *args)

    def goto(self, x: int, y: int, z: int, *extra_args: CommandArg) -> CommandDispatchResult:
...
Source: `GotoCommand.java`"""
        return dispatch_sync(self, 'goto', x, y, z, *extra_args)

    def goto_wait(self, x: int, y: int, z: int, *extra_args: CommandArg) -> dict[str, Any]:
        """Dispatch `goto` and wait for its terminal task event."""
        return dispatch_and_wait_sync(self, 'goto', x, y, z, *extra_args)

    def invert(self, *args: CommandArg) -> CommandDispatchResult:
...
Source: `InvertCommand.java`"""
        return dispatch_sync(self, 'invert', *args)

    def path(self, *args: CommandArg) -> CommandDispatchResult:
...
Source: `PathCommand.java`"""
        return dispatch_sync(self, 'path', *args)

    def surface(self, *args: CommandArg) -> CommandDispatchResult:
...
Source: `SurfaceCommand.java`"""
        return dispatch_sync(self, 'surface', *args)

    def thisway(self, *args: CommandArg) -> CommandDispatchResult:
...
Source: `ThisWayCommand.java`"""
        return dispatch_sync(self, 'thisway', *args)

    def tunnel(self, *args: CommandArg) -> CommandDispatchResult:
...
Source: `TunnelCommand.java`"""
        return dispatch_sync(self, 'tunnel', *args)

    def forward(self, *args: CommandArg) -> CommandDispatchResult:
        """Alias for `thisway`."""
        return self.thisway(*args)

    def highway(self, *args: CommandArg) -> CommandDispatchResult:
        """Alias for `axis`."""
        return self.axis(*args)

    def top(self, *args: CommandArg) -> CommandDispatchResult:
        """Alias for `surface`."""
        return self.surface(*args)
